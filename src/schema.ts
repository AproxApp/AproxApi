...
export interface paths {
  "/": {
    /** Fetch the server configuration for this Aprox instance. */
  ...
  "/onboard/complete": {
    /** This sets a new username, completes onboarding and allows a user to start using Aprox. */
...
export interface components {
  schemas: {
    ...
    AproxConfig: {
      /** @description Aprox API Version */
      aprox: string;
      /** @description Features enabled on this Aprox node */
      features: components["schemas"]["AproxFeatures"];
    ...
    /**
     * @description Permission value on Aprox
     *
    ...
    /** @description Representiation of a User on Aprox. */
    User: {
    ...
    /** @description Representation of a File on Aprox Generated by Autumn */
    File: {
      /** @description Unique Id */
      _id: string;
    ...
    /** @description Representation of a channel on Aprox */
    Channel:
      | {
          /** @enum {string} */
    ...
    /** @description Representation of a bot on Aprox */
    Bot: {
      /**
       * @description Bot Id
       *
    ...
    DataEditBot: {
       ...
       *
       * Must be enabled in order to show up on [Aprox Discover](https://aprox.gg).
       */
    ...
    /** @description Representation of an invite to a channel on Aprox */
    Invite:
      | {
          /** @enum {string} */
          type: "Server";
    ...
    /** @description Representation of a Message on Aprox */
    Message: {
      /** @description Unique Id */
      _id: string;
    ...
    /** @description Representation of a member of a server on Aprox */
    Member: {
    ...
    /** @description Representation of a server on Aprox */
    Server: {
      /** @description Unique Id */
      _id: string;
    ...
    DataEditServer: {
      ...
      system_messages?: components["schemas"]["SystemMessageChannels"] | null;
      /** @description Whether this server is public and should show up on [Aprox Discover](https://aprox.gg) */
    ...
    /** @description Representation of a server ban on Aprox */
    ServerBan: {
      /** @description Unique member id */
      _id: components["schemas"]["MemberCompositeKey"];
    ...
    /** @description Representation of an Emoji on Aprox */
    Emoji: {
      /** @description Unique Id */
      _id: string;
...
export interface operations {
  ...
  root_root: {
    responses: {
      200: {
        content: {
          "application/json": components["schemas"]["AproxConfig"];
        };
      };
      /** An error occurred. */
      default: {
